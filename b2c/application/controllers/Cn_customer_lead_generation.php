...
class Cn_customer_lead_generation extends CI_Controller {

    function __construct() {
        parent::__construct(); //It calls the Parent constructor
       $this->load->model('Md_database');
       $this->load->model('Md_customer');
       $this->load->model('Md_header');
       $this->session_management_lib->index();

    }
 public function lead_generation_form() {
        
        $data['page_title'] = "Lead Genaration Form";
        $data['page_name'] = 'lead-genaration-form';   
        ...
        $data['meta_description'] = 'Tell us what you are looking for share your details and our executive will get in touch with you.';   
        $this->load->view('vw_lead_generation_form', $data);
    } 
    
  public function ajax_lead_generation_form_submit_action() {
