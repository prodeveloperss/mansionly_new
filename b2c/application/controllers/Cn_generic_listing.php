...
//       $data['cat_list'] = $this->Md_generic_listing->getCatList($cat_id);
       ...
       if(($pageType=="PLP") && (empty($cat_id))){
           ...
           $data['meta_description'] = $soh_deatils[0]['metaDescription']?$soh_deatils[0]['metaDescription']:'';
           $data['page_title'] = $soh_deatils[0]['metaTitle']?$soh_deatils[0]['metaTitle']:'';
           $data['meta_keywords'] = ''; 
       }
...
//       $data['cat_list'] = $this->Md_generic_listing->getCatList($cat_id);
  ...
  //echo "<pre>";  print_r($arr_num_of_product_list);die;
