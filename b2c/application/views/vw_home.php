...
<section class="newsfeed_section clearfix" style="padding: 45px 0 0 0;">
   ...
   <p> <!--Bring to table win-win survival strategies ensure--></p>
...
<!--          <div class="SctImg">
    ...
    <ul>
    <li><span><img src="<?php echo base_url().SitePath ; ?>assets/img/hw01.png" alt="INTERNATIONAL BRANDS"></span><p>INTERNATIONAL BRANDS</p></li>
    <li><span><img src="<?php echo base_url().SitePath ; ?>assets/img/hw02.png" alt="BEST DESIGNERS"></span><p>BEST DESIGNERS</p></li>
    <li><span><img src="<?php echo base_url().SitePath ; ?>assets/img/hw03.png" alt="BEST IN CLASS EXECUTION"></span><p>BEST IN CLASS EXECUTION</p></li>
    </ul>
