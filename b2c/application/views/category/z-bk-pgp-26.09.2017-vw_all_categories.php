                ...
                ?>  
                    ...
                    <div class="CatThumb-otr">
                      <div class="CatThumb">
                          ...
                          <a href="<?php echo base_url(); ?>productlist/<?php echo $row_sub_cat['cat_id']; ?>/<?php echo urlencode($row_sub_cat['cat_name']) ;?>?q=<?php echo $q; ?>">
                            <img src="<?php echo image_url; ?>media/images/ecom/product/<?php echo $product_list[0]['product_image'];?>" >	
                          </a>  
                          <div class="cattitle"> 
