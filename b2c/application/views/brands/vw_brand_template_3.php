...
<!--------------[ Middle Section ]------------->
  ...
  <section class="brand-v1 brandv3">
           ...
           <?php } ?>
            ...
            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-12">
              <div class="BrandV1-des">
                ...
                <?php } ?>
                <!--<a class="brandv1-btn" href="<?php echo base_url().'brand/'.$brand_details[0]['brand_id'].'/'.urlencode($brand_details[0]['brand_name']).'?q='.$q.'&pgtyp=dft';?>">View entire collection</a>--> 
...
//    }
    ...
    //echo "<pre>"; print_r($exit_product_list);
    $product_list=array();
    $view_all_url = "";
    if($row['type']=="CAT"){  
    ...
    <?php } ?>
    <div class="clearfix"></div>
    <div class="BrandV3-product-list-second clearfix">  
      <div class="container">
        <div class="col-md-12 ">
          <div class="row">
            <ul>
              <li>
                <h2> <span> <?php echo $section_name; ?></span></h2>
              </li>
              ...
              <li> 
                ...
                <div class="BrandV3-product-list-box ">
                  <div class="BrandV3-img"> <img src="<?php echo image_url; ?>media/images/ecom/product/<?php echo $row['product_image'];?>"> </div>
                </div>
   ...
   <?php } else if(count($product_list)== 6){ ?> 
    ...
    <?php } ?>
    <div class="clearfix"></div>
    <div class=" BrandV3-product-list-secondFurniture clearfix">
      <div class="container">
        <div class="col-md-12 ">
          <div class="row">
            <ul>
            
            <div class=" di-heading visible-xs">
<!--                <h2> Bed <span> Room Furniture </span></h2>-->
               <h2> <span> <?php echo $section_name; ?></span></h2>
            </div>
    ...
    <?php } ?>
    <div class="clearfix"></div>
    <div class="BrandV3-product-list-secondDining clearfix">
      <div class="container">
        <div class="col-md-12">
          <div class="row">
            ...
            <div class="DinginFur">
              <ul>
                ...
                <li> 
                  <a class="likeico" href="javascript:void(0);" ><i id="<?php echo 'marketseller'.$row['product_id'];?>" class="fa fa-heart <?php if(in_array($row['product_id'], $customerFavoriteProduct)){echo ' heartRed';}?>" aria-hidden="true" onclick="saveFavorite('Product','marketseller',<?php echo $row['product_id'];?> );"></i></a>
                  <!--<a class="" href="<?php echo base_url(); ?>product-details/<?php echo $row['product_id']; ?>/<?php echo urlencode($row['product_name']) ;?>?q=<?php echo $q; ?>">-->
                  <a class="" href="<?php echo base_url().strtolower(urlencode(str_replace($url_replace_char_array, '-', $row['product_name']))).'/pdp/'.$row['product_id']; ?>?q=<?php echo $q; ?>">
                  <div class="BrandV3-product-list-box ">
                    <div class="BrandV3-img"> <img src="<?php echo image_url; ?>media/images/ecom/product/<?php echo $row['product_image'];?>"> </div>
                  </div>
                  <div class="Bv3product-name clearfix"><?php echo $row['product_name'] ;?></div>
