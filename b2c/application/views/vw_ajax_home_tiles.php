  ...
  <div class="container">
  	<div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="BlogCIMg"> 
                <img src="<?php echo $blog['imageUrl']; ?>"  alt="<?php echo $blog['post_title']; ?>"></div>
            ...
            <?php if($tile['tileType']=='executionPortfolio'){ ?>
                <div class="col-md-4 col-sm-4 col-xs-12">
                        ...
                        <div class="BlockRepeat_Img clearfix"> 
                            <img src="<?php echo image_url ; ?>media/images/master-execution-images/370X270/<?php echo $tile['master_image']; ?>"  alt="<?php echo $tile['portfolio_name'].'-'.$tile['designer_name']; ?>"></div>
                        <div class="BlockRepeat_Text clearfix">
                        <span class="hearts"> 
        ...
        <div class="col-md-4 col-sm-4 col-xs-12">
        	<div class="BlockRepeat clearfix">
                ...
                <div class="BlockRepeat_Img clearfix"> 
                     <div class="DBrandImg">
                         <img src="<?php echo image_url ; ?>media/images/ecom/brand/200X110/<?php echo $tile['brand_image']; ?>" alt="<?php echo $tile['brand_name']; ?>" class="brandImgs" >
                     </div> 
                 <!--<img src="<?php echo base_url().SitePath ; ?>media/images/ecom/brand/brandBnrImgs/<?php echo $tile['brandBnrImg']; ?>"  alt="">-->
                    <img src="<?php echo image_url; ?>media/images/ecom/product/<?php echo $tile['brandTopProductImg']; ?>"  alt="<?php echo $tile['brand_name']; ?>" onerror="$(this).hide();">
                </div>
                <div class="BlockRepeat_Text clearfix">
        ...
        <div class="col-md-4 col-sm-4 col-xs-12">
        	<div class="BlockRepeat clearfix">
                ...
                <div class="BlockRepeat_Img clearfix"> <img src="<?php echo image_url ; ?>media/images/ecom/product/<?php echo $tile['product_image']; ?>"  alt="<?php echo $tile['product_name']; ?>"></div>
                <div class="BlockRepeat_Text clearfix">
                <span class="hearts"> <img src="<?php echo base_url().SitePath ; ?>assets/img/hearts.png"  alt=""></span>
                <!--<h4>PRODUCT</h4>-->
        ...
        <div class="col-md-4 col-sm-4 col-xs-12">
        	<div class="BlockRepeat clearfix">
                ...
                <div class="BlockRepeat_Img clearfix"> 
                            <?php if(!empty($tile['designer_logo'])){ ?> 
                    <div class="DesignerSqImg">
                        
                    	 <!--<img src="<?php echo base_url().SitePath ; ?>assets/img/gt_federica.jpg" alt="">-->
                         <img src="<?php echo image_url ; ?>media/images/designer-images/150X150/<?php echo $tile['designer_logo']; ?>"  alt="<?php echo $tile['designer_name']; ?>" onerror="$(this).hide();">
                     </div> 
                            <?php } ?>
                     <?php if (! empty($tile['portfolioImg'])) {?>
                    <img src="<?php echo image_url; ?>media/images/master-execution-images/370X270/<?php echo $tile['portfolioImg']; ?>" alt="<?php echo $tile['designer_name']; ?>">
                        <?php  } else if (! empty($tile['designThemeImg'])) {?>
                        <img src="<?php echo image_url; ?>media/images/masterdsg-img/388x300/<?php echo $tile['designThemeImg']; ?>" alt="<?php echo $tile['designer_name']; ?>" >
                         <?php  } else {?>  
        ...
        <div class="col-md-4 col-sm-4 col-xs-12">
        	<div class="BlockRepeat clearfix">
                ...
                <div class="BlockRepeat_Img clearfix"> <img src="<?php echo image_url ; ?>media/images/masterdsg-img/370X270/<?php echo $tile['design_img']; ?>"  alt="<?php echo $tile['design_display_name']; ?>"></div>
                <div class="BlockRepeat_Text clearfix">
                <span class="hearts"> <img src="<?php echo base_url().SitePath ; ?>assets/img/hearts.png"  alt=""></span>
