...
<!--        <li class="residential_interiors" <?php if($execution_flag =='residential_interiors'){?> style="display:block;" <?php } else {?>style="display:none;" <?php } ?>>
            <a href="<?php echo base_url(); ?>execution-gallery/residential_interiors?q=e">
               Execution Gallery
            </a>
        </li>-->
        <li <?php if($execution_flag =='residential_interiors'){?> style="display:block;" <?php } else {?>style="display:none;" <?php } ?>class="active residential_interiors">Premium Residences</li> 
        
<!--        <li class="global_inspiration" <?php if($execution_flag =='global_inspiration'){?> style="display:block;" <?php } else {?>style="display:none;" <?php } ?>>
            <a href="<?php echo base_url(); ?>execution-gallery/global_inspiration?q=e">
               Execution Gallery
            </a>
        </li>-->
        <li <?php if($execution_flag =='global_inspiration'){?> style="display:block;" <?php } else {?>style="display:none;" <?php } ?> class="active global_inspiration">Global Inspirations</li> 
       
<!--        <li class="luxury_hotels" <?php if($execution_flag =='luxury_hotels'){?> style="display:block;" <?php } else {?>style="display:none;" <?php } ?>>
            <a href="<?php echo base_url(); ?>execution-gallery/luxury_hotels?q=e">
               Execution Gallery
            </a>
        </li>-->
        <li <?php if($execution_flag =='luxury_hotels'){?> style="display:block;" <?php } else {?>style="display:none;" <?php } ?> class="active luxury_hotels">Luxury Hotels</li> 
        
<!--        <li class="office_space" <?php if($execution_flag =='office_space'){?> style="display:block;" <?php } else {?>style="display:none;" <?php } ?>>
            <a href="<?php echo base_url(); ?>execution-gallery/office_space?q=e">
               Execution Gallery
            </a>
        </li>-->
        <li <?php if($execution_flag =='office_space'){?> style="display:block;" <?php } else {?>style="display:none;" <?php } ?> class="active office_space">Office Space</li> 
     
<!--        <li class="restaurant" <?php if($execution_flag =='restaurant'){?> style="display:block;" <?php } else {?>style="display:none;" <?php } ?>>
            <a href="<?php echo base_url(); ?>execution-gallery/restaurant?q=e">
               Execution Gallery
            </a>
        </li>-->
        <li <?php if($execution_flag =='restaurant'){?> style="display:block;" <?php } else {?>style="display:none;" <?php } ?> class="active restaurant">Restaurant</li> 
        
<!--        <li class="spas" <?php if($execution_flag =='spas'){?> style="display:block;" <?php } else {?>style="display:none;" <?php } ?>>
            <a href="<?php echo base_url(); ?>execution-gallery/spas?q=e">
               Execution Gallery
            </a>
        </li>-->
        <li <?php if($execution_flag =='spas'){?> style="display:block;" <?php } else {?>style="display:none;" <?php } ?> class="active spas">Spas & Clubs</li> 
        
<!--        <li class="retail" <?php if($execution_flag =='retail'){?> style="display:block;" <?php } else {?>style="display:none;" <?php } ?>>
            <a href="<?php echo base_url(); ?>execution-gallery/retail?q=e">
               Execution Gallery
            </a>
        </li>-->
        <li <?php if($execution_flag =='retail'){?> style="display:block;" <?php } else {?>style="display:none;" <?php } ?> class="active retail">Retails</li> 
       
<!--        <li class="all" <?php if($execution_flag =='all'){?> style="display:block;" <?php } else {?>style="display:none;" <?php } ?>>
            <a href="<?php echo base_url(); ?>execution-gallery/all?q=e">
               Execution Gallery
            </a>
        </li>-->
        <li <?php if($execution_flag =='all'){?> style="display:block;" <?php } else {?>style="display:none;" <?php } ?> class="active all">View All</li> 
