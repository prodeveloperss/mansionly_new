...
<!--              <a class="likeico" href=""><i class="fa fa-heart" aria-hidden="true"></i></a>-->
                <div class="brand-wrap">
				  ...
				  <a href="<?php echo base_url();?><?php echo urlencode($row['title']);?>?sohID=<?php echo $row['id'];?>&pageType=PLP">
                                      <img src="<?php echo image_url; ?>media/images/ecom/product/<?php echo $product_details[0]['product_image'];?>" alt="<?php echo $row['title'];?>">
				  </a>
				  </div>
                  <div class="BrandName">
				  <a href="<?php echo base_url();?><?php echo urlencode($row['title']);?>?sohID=<?php echo $row['id'];?>&pageType=PLP">
