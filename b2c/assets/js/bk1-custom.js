...
/* -----------------------------------------Services----------------------------------------------------------------------------------*/
 ...
 $('a.projectLink').hover(function(e){
     $('.project').hide();
     
     $(e.target.dataset.target).show();
     $('a.projectLink').parent().removeClass('active');
     $(e.target.dataset.target).parent().addClass('active');
 });
 

//  $("#execution_gallary01").hover(function(){
//  $(".projectexecution01").text("Projects executed by our partners");
//  $("#project00").css('display','none');
//  $("#project01").css('display','none');
//  $("#project02").css('display','none');
//  $("#project03").css('display','none');
//  $("#project04").css('display','none');
//  $("#project05").css('display','none');
//
//  $("#projectlink00").parent().removeClass('active');
//  $("#projectlink01").parent().removeClass('active');
//  $("#projectlink02").parent().removeClass('active');
//  $("#projectlink03").parent().removeClass('active');
//  $("#projectlink04").parent().removeClass('active');
//  $("#projectlink05").parent().removeClass('active');
// 
//
// });
...
//  }); 
  ...
  $('li.dropdown a.dropdown-toggle').hover(function (e) {
      console.log(e.target.dataset.target);
      $('.dropdown-menu.megamenu.megaDrop2').hide();
      $(e.target.dataset.target).show();
      $(e.target.dataset.target+' .project').hide();
      $(e.target.dataset.target+' .project:first-of-type').show();
     $('a.projectLink').parent().removeClass('active');
    // $(e.target.dataset.target+' a.projectLink:first-of-type').parent().addClass('active');
	 $('body').removeClass('menuOpen');
